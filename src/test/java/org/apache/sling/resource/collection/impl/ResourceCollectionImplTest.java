...
public class ResourceCollectionImplTest {
    ...
    public void testAddResource() throws Exception {
        ...
        final Resource res1 = resResolver.create(
                resResolver.getResource("/"), "res1", Collections.singletonMap(PROPERTY_RESOURCE_TYPE, (Object)
                        "type"));
        collection.add(res1);
        final Resource resource = resResolver.create(
                resResolver.getResource("/"), "res2", Collections.singletonMap(PROPERTY_RESOURCE_TYPE, (Object)
                        "type"));
    ...
    public void testCheckPath() throws Exception {
        final Resource rootResource = resResolver.create(
                resResolver.getResource("/"), "root", Collections.singletonMap(PROPERTY_RESOURCE_TYPE, (Object)
                        "type"));
